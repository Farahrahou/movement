		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Mov App",
									"targetURL": "#beapsapmovapp-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"beapsapmovapp-display": {
								"semanticObject": "beapsapmovapp",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=be.ap.sap.movapp",
									"url": sap.ui.require.toUrl("be/ap/sap/movapp")
								}
							}
						}
					}
